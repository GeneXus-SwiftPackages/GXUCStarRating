...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCStarRating",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCStarRating-1.0.0-beta+20230609175617.xcframework.zip",
			checksum: "84d77c47022a9794918cd2df5d87ee9f8088798899673f5e00724663efe89e8b"
		)
	]
)