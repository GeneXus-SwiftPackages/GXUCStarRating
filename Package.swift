...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCStarRating",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCStarRating-2.2.0-beta.26.xcframework.zip",
			checksum: "b4d3e44bbca47d32866a88f8435934dffecd55ddaed08073b96da7fd22148d97"
		)
	]
)