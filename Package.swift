...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCStarRating",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCStarRating-1.0.0-beta+20230610052334.xcframework.zip",
			checksum: "a1cc3576c6fcab146c3b9767a3f7c835267b787b408f370e8b570366d7beda9a"
		)
	]
)