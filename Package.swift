...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCStarRating",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCStarRating-3.0.0-rc.2.xcframework.zip",
			checksum: "0ee7857ab96a627960e40d1b9733ba82f6628e6c4376618c6fc494705b1e9bff"
		)
	]
)