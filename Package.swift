...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCStarRating",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCStarRating-1.0.0-beta+20230608211628.xcframework.zip",
			checksum: "72a914767b2f73cc1dbd6dbcaee7d7d8e844cb4e76d0e19eb0cdfef0049e1d72"
		)
	]
)