...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCStarRating",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCStarRating-3.0.0-beta.4.xcframework.zip",
			checksum: "7694b09d1b4a37199f95a63d503c0267a446918b673b68c4e9f6b4be5e972b68"
		)
	]
)